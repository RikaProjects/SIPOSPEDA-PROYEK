...
$routes->get('dashboard-admin-produksi', 'Dashboard::adminProduksi');
$routes->get('dashboard-admin-gudang', 'Dashboard::adminGudang');
$routes->get('dashboard-admin-sales', 'Dashboard::adminSales');
$routes->get('dashboard-admin-factory', 'Dashboard::adminFactory');
...
$routes->get('keranjang/checkout', 'Mitra\Keranjang::checkout');        // Form checkout
$routes->post('keranjang/checkout', 'Mitra\Keranjang::checkout');       // Proses simpan transaksi
