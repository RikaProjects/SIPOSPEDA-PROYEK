          ...
          <form action="<?= base_url('admin/users/update/' . $user['id']) ?>" method="post">
            ...
            <div class="mb-3">
              ...
              <select name="role" class="form-control" required>
                ...
                <option value="admin_sales" <?= $user['role'] === 'admin_sales' ? 'selected' : '' ?>>Admin Sales</option>
                <option value="admin_gudang" <?= $user['role'] === 'admin_gudang' ? 'selected' : '' ?>>Admin Gudang</option>
                <option value="admin_factory" <?= $user['role'] === 'admin_factory' ? 'selected' : '' ?>>Admin Factory</option>
                ...
                <option value="calon_mitra" <?= $user['role'] === 'calon_mitra' ? 'selected' : '' ?>>Calon Pembeli</option>
              </select>
            </div>
